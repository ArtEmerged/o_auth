...
func (m *CreateUserRequest) validate(all bool) error {
	...
	if !_CreateUserRequest_Password_Pattern.MatchString(m.GetPassword()) {
		err := CreateUserRequestValidationError{
			field:  "Password",
			reason: "value does not match regex pattern \"^[A-Za-z\\\\d@$!%*#?&]{8,}$\"",
		}
		if !all {
			return err
		}
...
var _CreateUserRequest_Name_Pattern = regexp.MustCompile("^[A-Za-z]+([A-Za-z]+)*$")

var _CreateUserRequest_Password_Pattern = regexp.MustCompile("^[A-Za-z\\d@$!%*#?&]{8,}$")

var _CreateUserRequest_PasswordConfirm_Pattern = regexp.MustCompile("^[A-Za-z\\d@$!%*#?&]{8,}$")
...
func (m *UpdateUserRequest) validate(all bool) error {
	...
	if m.Name != nil {
		...
		if !_UpdateUserRequest_Name_Pattern.MatchString(m.GetName()) {
			err := UpdateUserRequestValidationError{
				field:  "Name",
				reason: "value does not match regex pattern \"^[A-Za-z]+( [A-Za-z]+)*$\"",
			}
...
var _UpdateUserRequest_Name_Pattern = regexp.MustCompile("^[A-Za-z]+( [A-Za-z]+)*$")
